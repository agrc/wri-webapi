...
namespace wri_shared
{
    [ComVisible(true)]
    [Guid("ce8e5c44-46e2-42c7-a93d-ebd6526d5b7c")]
    [ClassInterface(ClassInterfaceType.None)]
    [ServerObjectExtension("",//use "MapServer" if SOE extends a Map service and "ImageServer" if it extends an Image service.
        AllCapabilities = "",
        DefaultCapabilities = "",
        Description = "",
        DisplayName = "wri_shared",
        Properties = "",
        SupportsREST = true,
        SupportsSOAP = false)]
    public class wri_shared : IServerObjectExtension, IObjectConstruct, IRESTRequestHandler
    {
